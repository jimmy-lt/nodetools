...
class OmniStack(Node):
    """
    Cette classe automatise les différentes actions pour les systèmes OmniStack.
    """
    ...
    __more = '--More--'
    __password = re.compile('Password:\s', re.I)
    ...
    def __init__(self, mode, hostname, username, password =None, prompt =None,
                 timeout =15):
        """
        Constructeur de la classe OmniStack.
        """
    ...
    def get_privilege_level(self):
        ...
        for line in ret:
            ...
            if invalid_input:
                self.__level = self.__config_level
